                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <h2 className="text-3xl md:text-5xl font-extrabold mb-4 tracking-tight">
                            Get <span className="text-yellow-300">₦5,000 OFF</span> Your First Order
                        </h2>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                            ...
                            <Button variant="outline" size="lg" className="border-white text-red-900 bg-white/40 hover:bg-white/20 hover:text-white font-bold h-12 rounded-full backdrop-blur-sm">
                                Learn More
                            </Button>
                        </div>
                    </div>
                    ...
                    <div className="hidden md:block relative">
                        ...
                        >
                            <div className="border-2 border-dashed border-gray-300 p-4 rounded-lg bg-gray-50 w-64 text-center">
                                ...
                                <div className="text-2xl font-black text-gray-800 tracking-widest">WELCOME5000</div>
                                <div className="text-xs text-gray-400 mt-2">Valid until 30 Aug 2026</div>
                            </div>
                        </motion.div>
